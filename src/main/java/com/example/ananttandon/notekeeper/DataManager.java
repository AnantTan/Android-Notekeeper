...
import com.example.ananttandon.notekeeper.NotekeeperDatabaseContract.CourseInfoEntry;
import com.example.ananttandon.notekeeper.NotekeeperDatabaseContract.NoteInfoEntry;
...
public class DataManager {
   ...
   /* public static void loadFromDatabase(NotekeeperOpenHelper dbHelper){
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        ...
        dm.mCourses.clear();//start with a fresh list every time we load ir up
